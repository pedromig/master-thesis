...
\input{mainmatter/3-TheHashCodeProblems/sections/format.tex}

\section{Problems}
\label{sec:hashcode-problems}
\input{mainmatter/3-TheHashCodeProblems/sections/problems.tex}

\section{Instance Design}
\label{sec:hashcode-instance}
\input{mainmatter/3-TheHashCodeProblems/sections/instance.tex}

\section{Concluding Remarks}
\label{sec:hashcode-remarks}
\input{mainmatter/3-TheHashCodeProblems/sections/remarks.tex}
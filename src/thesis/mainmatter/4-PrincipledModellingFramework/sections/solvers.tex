...
The \Cref{lst:hc} describes a possible implementation of a
...
The \Cref{lst:bs} presents a possible implementation of a~\acrshort{beam-search}
...
in~\Cref{subsec:heuristic-construction}.

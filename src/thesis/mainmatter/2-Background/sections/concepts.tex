...
%% NOTE: Stochastic-Search in Meta-Heuristics
%% One may imagine then that the algorithm A repeatedly calls a “black-box”
%% procedure returning fitness values to given solutions x, but A does not “know” how
%% these fitness values are determined. In this case, A is called a black-box optimizer.

...
literature. In~\Cref{ch:principled-modelling-framework}, we discuss a modelling
...
Hash Code problems \textquote{Optimize a Data Center} and \textquote{Book Scanning},
with experimental results. Finally,~\Cref{ch:conclusion} summarizes findings in

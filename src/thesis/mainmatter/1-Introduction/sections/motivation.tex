...
these problems, the goal is usually to find \textquote{good} solutions in a
...
exact methods are often ineffective to solve~\textquote{real-world}~\acrshort{combinatorial-optimization} problems
